package com.bidata.library.HorizontalPicker;
...
import com.bidata.library.Listener.DatePickerListener;
...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public void init() {
        ...
        tvMonth.setTextColor(mMonthAndYearTextColor != -1 ? mMonthAndYearTextColor : getColor(R.color.colorPrimary));
        ...
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? getColor(R.color.Aluminium) : mDayOfWeekTextColor;
