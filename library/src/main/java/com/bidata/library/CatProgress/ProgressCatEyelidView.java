package com.bidata.library.CatProgress;
 ...
 */
public class ProgressCatEyelidView extends View {
    ...
    public ProgressCatEyelidView(Context context) {
        super(context);
        init();
    }


    public ProgressCatEyelidView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }


    public ProgressCatEyelidView(Context context, AttributeSet attrs, int defStyleAttr) {
