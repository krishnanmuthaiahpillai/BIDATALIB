...
package com.bidata.mylibrary.progress;
...
import com.bidata.mylibrary.R;
import com.bidata.mylibrary.progress.utils.OnProgressViewListener;
import com.bidata.mylibrary.progress.utils.ProgressShape;
import com.bidata.mylibrary.progress.utils.ProgressStartPoint;
...
abstract class ProgressView extends View implements ProgressShape {
    ...
    protected float strokeWidth = getResources().getDimension(R.dimen.default_stroke_width);
    protected float backgroundStrokeWidth = getResources().getDimension(R.dimen.default_background_stroke_width);
    ...
    public ProgressView(Context context) {
        ...
        shaderColor=ContextCompat.getColor(context, R.color.shader_color);
    }
